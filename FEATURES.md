...
**Read-only constraint for tracker *structure*:** the kit never creates tracker projects, labels, workflows, or sprint configurations on your behalf — those are externally-owned across most contexts (work JIRA, team Linear, etc.). Project-level structural artifacts must exist before bootstrap. See [ADR-0001 §D3](docs/adr/0001-multi-repo-folder-model.md) and `CONVENTIONS.md` "Ticket-driven workflows → What the kit does NOT do with trackers".
